...
df = pd.read_csv(r"C:\Ml projects By LJ\Health-App-main\data\diabetes.csv")
...
joblib.dump(model,r"C:\Ml projects By LJ\Health-App-main\Diabetes_API\diabetes_model.pkl")
