...
df = pd.read_csv(r"C:\Ml projects By LJ\Health-App-main\data\cancer.csv")
...
joblib.dump(model,r"C:\Ml projects By LJ\Health-App-main\Breast_Cancer API\cancer_model.pkl")
